...
const books = [
    ...
    {
        image_Url: "https://pictures.abebooks.com/inventory/md/md31408920801.jpg",
    ...
    {
        image_Url: "https://embed.cdn.pais.scholastic.com/v1/channels/sso/products/identifiers/isbn/9780590353427/primary/renditions/700",
        title: "Harry Potter",
        description:
    ...
    {
        image_Url: "https://pictures.abebooks.com/isbn/9780061205699-us.jpg",
    ...
    {
        image_Url: "https://pictures.abebooks.com/isbn/9780553213102-us.jpg",
    ...
    {
        image_Url: "https://pictures.abebooks.com/isbn/9781904233640-us.jpg",
        title: "Twilight",
        description:
    ...
    {
        image_Url: "https://embed.cdn.pais.scholastic.com/v1/channels/sso/products/identifiers/isbn/9780375842207/primary/renditions/700",
    ...
    {
        image_Url: "https://cdn.shopify.com/s/files/1/0104/1203/2085/products/9780007323128_262x.jpg?v=1668019544",
    ...
    {
        image_Url: "https://pictures.abebooks.com/isbn/9780141036137-us.jpg",
        title: "Animal Farm",
        description:
    ...
    {
        image_Url: "https://pictures.abebooks.com/isbn/9789382616597-us.jpg",
    ...
    {
        image_Url: "https://pictures.abebooks.com/isbn/9780141345659-us.jpg",
...
Book.insertMany(books)
    ...
    .catch((err) => console.log('Error while creating books: ', err));
